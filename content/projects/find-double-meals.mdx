...
description: "Automation that detects duplicate meal modifiers, recalculates ingredient requirements, and publishes corrected buying outputs with Slack notifications."
date: "2025-09-15"
type: "automation"
...
businessOutcome: "Reduced ingredient-ordering errors caused by duplicate meal modifiers in buying outputs"
serviceLines: ["automation"]
clientType: "meal delivery operations team"
confidential: true
