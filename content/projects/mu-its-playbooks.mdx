...
Murdoch University ITS wanted a more standardised and repeatable approach to handling incidents — one that reduces ambiguity and supports responders under pressure.
...
<PhaseGrid
  ...
  items={[
    ...
    { title: "Lessons Learned", tone: "lessons" },
  ]}
/>
